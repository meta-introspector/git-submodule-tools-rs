{
  description = "Nix flake for vendor_meta_introspector_meta_meme_wiki";
  ...
  outputs = { self, nixpkgs }:
    ...
    in {
      packages.${system}.vendor_meta_introspector_meta_meme_wiki = pkgs.stdenv.mkDerivation {
        pname = "vendor_meta_introspector_meta_meme_wiki";
        ...
        meta = with pkgs.lib; {
          description = "Git submodule: vendor_meta_introspector_meta_meme_wiki";
          homepage = "https://github.com/meta-introspector/meta-meme.wiki.git";
