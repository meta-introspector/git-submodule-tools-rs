{
  description = "Nix flake for vendor_octocrab";
  ...
  outputs = { self, nixpkgs }:
    ...
    in {
      packages.${system}.vendor_octocrab = pkgs.stdenv.mkDerivation {
        pname = "vendor_octocrab";
        version = "0.1.0"; # Placeholder, can be updated later

        src = pkgs.fetchgit {
          url = "github:meta-introspector/octocrab?ref=feature/CRQ-016-nixify";
        ...
        meta = with pkgs.lib; {
          description = "Git submodule: vendor_octocrab";
          homepage = "github:meta-introspector/octocrab?ref=feature/CRQ-016-nixify";
