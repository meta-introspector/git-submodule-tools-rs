{
  description = "Nix flake for vendor_meta_introspector_meta_meme";
  ...
  outputs = { self, nixpkgs }:
    ...
    in {
      packages.${system}.vendor_meta_introspector_meta_meme = pkgs.stdenv.mkDerivation {
        pname = "vendor_meta_introspector_meta_meme";
        ...
        meta = with pkgs.lib; {
          description = "Git submodule: vendor_meta_introspector_meta_meme";
          homepage = "https://github.com/meta-introspector/meta-meme";
