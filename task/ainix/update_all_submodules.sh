#!/usr/bin/env bash
#
# Script to update all Git submodules (initialize and update).
#
...
LOG_FILE="${LOG_DIR}/update_all_submodules_${TIMESTAMP}.log"
STRACE_LOG_FILE="${LOG_DIR}/strace_update_all_submodules_${TIMESTAMP}.log"
...
log_info "Starting all submodules update script."
...
log_info "Verifying all submodules status..."
run_command git submodule status

log_info "All submodules update script finished."
