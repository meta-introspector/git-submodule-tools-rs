{
  ...
  outputs = { self, nixpkgs } :
    let
      # Define mkSubmodule as a function that takes configurable submoduleUrl, submoduleRev, and an optional submoduleSha256.
      # This allows for flexible and configurable submodule checkouts.
      mkSubmodule = { submoduleUrl, submoduleRev, submoduleSha256 ? "sha256-AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=" } :
        let
        ...
        in
        {
          packages = forAllSystems (system:
            ...
            pkgs.stdenv.mkDerivation {
              ...
              # The submoduleUrl, submoduleRev, and submoduleSha256 are configurable arguments of the mkSubmodule function.
    ...
    in
    {
      inherit mkSubmodule; # Expose the mkSubmodule function
    };
}